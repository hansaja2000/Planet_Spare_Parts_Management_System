...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.3)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Planet Spare Parts</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#elec" class="dropdown-item">Electric Parts</a>
                                   <a href="products.php#trans" class="dropdown-item">Transmission parts</a>
                                   <a href="products.php#nut" class="dropdown-item">nut and bolt parts</a>
                                   <a href="products.php#rubber" class="dropdown-item">rubber parts</a>
                               </div>
